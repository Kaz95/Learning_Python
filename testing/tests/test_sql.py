...
class TestSQL(unittest.TestCase):
    ...
    def test_execute_fetchall_sql(self):
        with patch('testing.database.sqlite3') as mocksql:
            ...
            response = testing.sql.execute_fetchall_sql(conn, """SELECT username, password FROM accounts;""")
