...
for character in message:   # Iterate over all characters in a string(including spaces!).
    ...
    count[character] = count[character] + 1  # Adds 1 to the current characters count. Would return error without above.
pprint.pprint(count)  # Capital characters count separate from lower case. pprint.pformat to return as string.
